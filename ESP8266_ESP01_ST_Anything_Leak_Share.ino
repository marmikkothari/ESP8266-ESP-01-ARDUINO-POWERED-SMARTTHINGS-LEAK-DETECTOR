...
String str_password = "YOUR_SSID_PW_HERE";                   //  <---You must edit this line!
IPAddress ip(192, 168, 1, 11);       // Device IP Address      //  <---You must edit this line!
...
//  static st::IS_Motion sensor1(F("motion1"), PIN_MOTION, LOW, true);
  static st::IS_Contact sensor2(F("contact1"), PIN_CONTACT, LOW, true); //Using the Contact device handler as a Digital Water Sensor.
